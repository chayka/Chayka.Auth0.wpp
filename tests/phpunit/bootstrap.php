...
tests_add_filter( 'muplugins_loaded', function() use ($_core_dir){
	require $_core_dir. 'wp-content/plugins/Chayka.Core.wpp/Chayka.Core.wpp.php';
	require dirname( dirname( dirname( __FILE__ ) ) ). '/Chayka.Auth0.wpp.php';
});
